...
class CardCreator {
    ...
    private CardCreator()
    {
        cardData = new HashMap<String, Card>(){{
    		put("Forest", new Card("Forest", "Adds cards from exploring the forest.", new Image("file:src/resources/Forest Booster.png"), 0));
    	    ...
    	    put("Rope", new Card("Rope", "Discards 2 cards from opponents hand", new Image("file:src/resources/Rope.png")));
    	    put("Bandage", new Card("Bandage", "Create 2 Bandages.", new Image("file:src/resources/Bandage.png"), 2));
    	}};
